...
from errors import CKANAPIError
from common import (ActionShortcut, prepare_action,
...
class RemoteCKAN(object):
    ...
    def _request_fn(self, url, data, headers, files, requests_kwargs):
        r = requests.post(url, data=data, headers=headers, files=files, verify=False, **requests_kwargs)
